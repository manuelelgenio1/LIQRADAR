      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-[13px] leading-relaxed text-mist">
            El motor se ejecuta <b className="text-fog">por separado en 1h, 4h y 1d</b> — estos tres horizontes de
            confirmación son fijos y no cambian con la temporalidad del gráfico. Cuando todos miran al mismo
